...
3. Drag the **Save To Neshanak** button (the terracotta mark plus the label) onto that bar. Clicking it on the Settings page does nothing; it only works from the bar.
